...
func (s *PresenceService) UpsertLocalClusterName(ctx context.Context, name string) error {
...
func (s *PresenceService) GetLocalClusterName(ctx context.Context) (string, error) {
	item, err := s.Get(ctx, backend.Key(localClusterPrefix, valPrefix))
	if err != nil {
		return "", trace.Wrap(err)
	}
...
func (s *PresenceService) DeleteAllNamespaces(ctx context.Context) error {
	return s.DeleteRange(ctx, backend.Key(namespacesPrefix), backend.RangeEnd(backend.Key(namespacesPrefix)))
}

// GetNamespaces returns a list of namespaces
func (s *PresenceService) GetNamespaces(ctx context.Context) ([]types.Namespace, error) {
	result, err := s.GetRange(ctx, backend.Key(namespacesPrefix), backend.RangeEnd(backend.Key(namespacesPrefix)), backend.NoLimit)
	if err != nil {
...
func (s *PresenceService) UpsertNamespace(ctx context.Context, n types.Namespace) error {
...
func (s *PresenceService) GetNamespace(ctx context.Context, name string) (*types.Namespace, error) {
	if name == "" {
		return nil, trace.BadParameter("missing namespace name")
	}
	item, err := s.Get(ctx, backend.Key(namespacesPrefix, name, paramsPrefix))
	if err != nil {
...
func (s *PresenceService) DeleteNamespace(ctx context.Context, namespace string) error {
	if namespace == "" {
		return trace.BadParameter("missing namespace name")
	}
	err := s.Delete(ctx, backend.Key(namespacesPrefix, namespace, paramsPrefix))
	if err != nil {
		if trace.IsNotFound(err) {
...
func (s *PresenceService) UpsertNodes(ctx context.Context, namespace string, servers []types.Server) error {
...
func (s *PresenceService) GetAuthServers(ctx context.Context) ([]types.Server, error) {
	return s.getServers(ctx, types.KindAuthServer, authServersPrefix)
}
...
func (s *PresenceService) DeleteAllAuthServers(ctx context.Context) error {
	startKey := backend.Key(authServersPrefix)
	return s.DeleteRange(ctx, startKey, backend.RangeEnd(startKey))
}

// DeleteAuthServer deletes auth server by name
func (s *PresenceService) DeleteAuthServer(ctx context.Context, name string) error {
...
func (s *PresenceService) GetProxies(ctx context.Context) ([]types.Server, error) {
	return s.getServers(ctx, types.KindProxy, proxiesPrefix)
}

// DeleteAllProxies deletes all proxies
func (s *PresenceService) DeleteAllProxies(ctx context.Context) error {
...
func (s *PresenceService) GetReverseTunnel(ctx context.Context, name string, opts ...services.MarshalOption) (types.ReverseTunnel, error) {
	item, err := s.Get(ctx, backend.Key(reverseTunnelsPrefix, name))
	if err != nil {
		return nil, trace.Wrap(err)
	}
...
func (s *PresenceService) DeleteReverseTunnel(ctx context.Context, clusterName string) error {
	err := s.Delete(ctx, backend.Key(reverseTunnelsPrefix, clusterName))
	return trace.Wrap(err)
}
...
func (s *PresenceService) UpsertTunnelConnection(ctx context.Context, conn types.TunnelConnection) error {
...
func (s *PresenceService) GetTunnelConnection(ctx context.Context, clusterName, connectionName string, opts ...services.MarshalOption) (types.TunnelConnection, error) {
	item, err := s.Get(ctx, backend.Key(tunnelConnectionsPrefix, clusterName, connectionName))
	if err != nil {
		if trace.IsNotFound(err) {
...
func (s *PresenceService) GetTunnelConnections(ctx context.Context, clusterName string, opts ...services.MarshalOption) ([]types.TunnelConnection, error) {
	if clusterName == "" {
...
func (s *PresenceService) GetAllTunnelConnections(ctx context.Context, opts ...services.MarshalOption) ([]types.TunnelConnection, error) {
...
func (s *PresenceService) DeleteTunnelConnection(ctx context.Context, clusterName, connectionName string) error {
	if clusterName == "" {
	...
	return s.Delete(ctx, backend.Key(tunnelConnectionsPrefix, clusterName, connectionName))
}

// DeleteTunnelConnections deletes all tunnel connections for cluster
func (s *PresenceService) DeleteTunnelConnections(ctx context.Context, clusterName string) error {
	if clusterName == "" {
		return trace.BadParameter("missing cluster name")
	}
	startKey := backend.Key(tunnelConnectionsPrefix, clusterName)
...
func (s *PresenceService) DeleteAllTunnelConnections(ctx context.Context) error {
	startKey := backend.Key(tunnelConnectionsPrefix)
	err := s.DeleteRange(ctx, startKey, backend.RangeEnd(startKey))
	return trace.Wrap(err)
}
...
func (s *PresenceService) CreateRemoteCluster(ctx context.Context, rc types.RemoteCluster) error {
...
func (s *PresenceService) GetRemoteCluster(ctx context.Context, clusterName string) (types.RemoteCluster, error) {
	_, rc, err := s.getRemoteCluster(ctx, clusterName)
